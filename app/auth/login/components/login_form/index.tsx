...
export function LoginForm({ onLogin }: Props) {
  ...
  return (
    <form
      ...
      className="flex flex-col max-w-md space-y-4 min-w-[300px] items-center justify-center shadow-xl px-10 py-10"
    >
      ...
      <Link
        ...
        className="self-start text-secondary_blue hover:text-blue-600 transition-colors duration-200"
      >
        Esqueceu sua senha?
      </Link>
      ...
      <p className="text-center">
        Se você é profissional da saúde de uma UBS no estado do Maranhão, faça o seu registro e
        comece a usar a nossa plataforma de teleconsultoria.
      </p>
    </form>
  );
}
